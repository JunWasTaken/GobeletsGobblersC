...
void menu(){
   ...
   printf("\033[1;1f");
    ...
    printf("   %s  / _ \\ ___  | |__  | |__  | |  ___ | |_    %s__ _   ___  | |__  | |__    ___ | |  ___  _ __  ___ \n", BLEU, ROUGE);
    printf("   %s / /_\\// _ \\ | '_ \\ | '_ \\ | | / _ \\| __|  %s/ _` | / _ \\ | '_ \\ | '_ \\  / _ \\| | / _ \\| '__|/ __|\n", BLEU, ROUGE);
    printf("   %s/ /_\\\\| (_) || |_) || |_) || ||  __/| |_  %s| (_| || (_) || |_) || |_) ||  __/| ||  __/| |   \\__ \\\n", BLEU, ROUGE);
    printf("   %s\\____/ \\___/ |_.__/ |_.__/ |_| \\___| \\__|  %s\\__, | \\___/ |_.__/ |_.__/  \\___||_| \\___||_|   |___/\n", BLEU, ROUGE);
    printf("   %s                                           |___/%s\n", ROUGE, BLANC);
